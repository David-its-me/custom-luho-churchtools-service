...
import propresenter.pb_auto_generated.masks_pb2 as _masks_pb2
import propresenter.pb_auto_generated.screens_pb2 as _screens_pb2
import propresenter.pb_auto_generated.layers_pb2 as _layers_pb2
import propresenter.pb_auto_generated.targets_pb2 as _targets_pb2
import propresenter.pb_auto_generated.playlist_pb2 as _playlist_pb2
...
import propresenter.pb_auto_generated.calendar_pb2 as _calendar_pb2
import propresenter.pb_auto_generated.alignmentGuide_pb2 as _alignmentGuide_pb2
import propresenter.pb_auto_generated.liveVideoPlaylist_pb2 as _liveVideoPlaylist_pb2
...
class Workspace(_message.Message):
    ...
    class EditorBackground(_message.Message):
        ...
        opacity: float
        def __init__(self, enabled: bool = ..., frame: _Optional[_Union[_graphicsData_pb2.Graphics.Rect, _Mapping]] = ..., url: _Optional[_Union[_basicTypes_pb2.URL, _Mapping]] = ..., opacity: _Optional[float] = ...) -> None: ...
    ...
    effect_preset_uuid: _basicTypes_pb2.UUID
    effect_build_duration: float
    transition: _effects_pb2.Transition
    active_mask_uuid: _basicTypes_pb2.UUID
